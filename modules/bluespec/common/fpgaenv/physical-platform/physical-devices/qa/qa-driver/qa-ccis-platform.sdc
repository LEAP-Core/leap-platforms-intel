...
set pin_col [get_pins -compatibility_mode {*|*|*|llpi_phys_plat_qa_device|syncChannelReadQ|sNotFullReg|clk}]
...
if {0 == [get_collection_size $pin_col]} {
    ...
    set clk_sys_name   [get_clocks_feeding_pin {*|*|*|llpi_phys_plat_qa_device|syncChannelReadQ|sNotFullReg|clk}]
    ...
    set clk_model_name [get_clocks_feeding_pin {*|*|*|llpi_phys_plat_qa_device|syncChannelReadQ|dNotEmptyReg|clk}]
